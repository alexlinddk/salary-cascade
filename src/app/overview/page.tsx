...
import { CascadeBar } from "../../components/cascade-bar";
    ...
    return (
        <div>
            <div className="text-center py-12">
                ...
                <h1
                    className={`text-6xl sm:text-7xl font-light tracking-tight tabular-nums ${isDeficit ? "text-danger" : "text-free"
                        }`}
                >
